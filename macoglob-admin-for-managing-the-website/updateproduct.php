...
if (isset($_GET['id'])) {
    ...
    $getproductresult = mysqli_query($connection, $getproductquery);
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="container form-container">
                ...
                <?php
                while ($productsRow = mysqli_fetch_assoc($getproductresult)){
                    $category = $productsRow['category_id'];
                    ?>
                ...
                <form id="productForm" action="/insert-product" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select type="number" class="form-control" id="category_id" name="category_id" required>
                            <option disabled>--select a category from below---</option>
                            <?php
